...
export default function GareMontparnassePage() {
  const { t } = useLanguage();
  const stationKey = 'gare_montparnasse';
      ...
      <main>
        ...
        <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="container text-center text-white py-24 pt-36">
            ...
            >
              Taxi Moto <span className="text-brand">{t('nav.montparnasse')}</span>
            </motion.h1>
        ...
        <section className="section container text-center">
          <div className="bg-brand/10 rounded-2xl md:rounded-3xl p-8 md:p-12 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href={`/?pickup=Paris&dropoff=${t('nav.montparnasse')}&fare=60&luggage=1#reservation`}
